...
// Fallback hard-coded 6 stations — used if API fetch fails
const FALLBACK: StationRow[] = [
  { id: "ZNX-A1", name: "Zunex One", location: "Gateway Mall", city: "Mumbai", state: "Maharashtra", lat: 19.0760, lng: 72.8777, deviceModel: "plus", installType: "mall", liveStatus: "busy", connectionStatus: "online", firmwareVersion: "v2.0.4", lastSeenAt: Date.now() - 2000 },
  { id: "ZNX-B2", name: "ZUNEX B2", location: "MG Road Store", city: "Bangalore", state: "Karnataka", lat: 12.9716, lng: 77.5946, deviceModel: "core", installType: "retail", liveStatus: "available", connectionStatus: "online", firmwareVersion: "v2.1.4", lastSeenAt: Date.now() - 4000 },
  { id: "ZNX-L1", name: "ZUNEX L1", location: "NH8 Rest Stop", city: "Delhi", state: "Delhi", lat: 28.6139, lng: 77.2090, deviceModel: "plus", installType: "highway", liveStatus: "offline", connectionStatus: "offline", firmwareVersion: "v2.2.4", lastSeenAt: Date.now() - 3_600_000 },
  { id: "ZNX-K3", name: "ZUNEX K3", location: "Chennai Tech Park", city: "Chennai", state: "Tamil Nadu", lat: 13.0827, lng: 80.2707, deviceModel: "core", installType: "office", liveStatus: "available", connectionStatus: "online", firmwareVersion: "v2.3.4", lastSeenAt: Date.now() - 1500 },
  { id: "ZNX-M1", name: "ZUNEX M1", location: "Hyundai Service Centre", city: "Hyderabad", state: "Telangana", lat: 17.3850, lng: 78.4867, deviceModel: "plus", installType: "car", liveStatus: "available", connectionStatus: "online", firmwareVersion: "v2.4.4", lastSeenAt: Date.now() - 3000 },
  { id: "ZNX-C1", name: "ZUNEX C1", location: "Park Street Charging Hub", city: "Kolkata", state: "West Bengal", lat: 22.5726, lng: 88.3639, deviceModel: "core", installType: "outdoor", liveStatus: "busy", connectionStatus: "online", firmwareVersion: "v2.5.4", lastSeenAt: Date.now() - 1800 },
];
